...
/**
 * @license angular-bootstrap-datetimepicker  version: 0.4.1
 * Copyright 2017 Francesco Stasi
 */
  ...
  angular.module('ui.bootstrap.datetimepicker', [])
    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', function datetimepickerDirective($log, defaultConfig) {
      ...
      var validateConfiguration = function validateConfiguration(configuration) {
        ...
        configuration.timezone = configuration.timezone || 'Etc/UTC';
        configuration.timeformat = configuration.timeformat || 'MMM YYYY-MM-DD H:mm z';
        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          var dataFactory = {
            year: function year(unixDate) {
              ...
              for (var i = 0; i < 12; i += 1) {
                ...
                var dateValue = {
                  ...
                  'display': moment.tz(yearMoment, configuration.timezone).format('YYYY'),
            ...
            month: function month(unixDate) {
              ...
              var activeDate = ngModelController.$modelValue ? moment.tz(ngModelController.$modelValue, configuration.timeformat, configuration.timezone).format('YYYY-MMM') : 0;
              ...
              var result = {
                ...
                'previousViewDate': new DateObject({
                  ...
                  display: moment.tz(startDate, configuration.timezone).format('YYYY')
                }),
              ...
              for (var i = 0; i < 12; i += 1) {
                ...
                var dateValue = {
                  ...
                  'display': moment.tz(monthMoment, configuration.timezone).format('MMM'),
                  'active': moment.tz(monthMoment, configuration.timezone).format('YYYY-MMM') === activeDate
                };
            ...
            day: function day(unixDate) {
              ...
              var activeDate = ngModelController.$modelValue ? moment.tz(ngModelController.$modelValue, configuration.timeformat, configuration.timezone).format('YYYY-MMM-DD') : '';
              ...
              var result = {
                ...
                'previousViewDate': new DateObject({
                  utcDateValue: previousViewDate.valueOf(),
                  display: moment.tz(startOfMonth, configuration.timezone).format('YYYY-MMM')
                }),
              ...
              for (var i = 0; i < 6; i += 1) {
                ...
                for (var j = 0; j < 7; j += 1) {
                  ...
                  var dateValue = {
                    'utcDateValue': monthMoment.valueOf(),
                    'display': moment.tz(monthMoment, configuration.timezone).format('D'),
                    'active': moment.tz(monthMoment, configuration.timezone).format('YYYY-MMM-DD') === activeDate,
            ...
            hour: function hour(unixDate) {
              ...
              var activeFormat = ngModelController.$modelValue ? moment.tz(ngModelController.$modelValue, configuration.timeformat, configuration.timezone).format('YYYY-MM-DD H') : '';
              ...
              var result = {
                ...
                'previousViewDate': new DateObject({
                  utcDateValue: previousViewDate.valueOf(),
                  display: moment.tz(selectedDate, configuration.timezone).format('ll')
                }),
              ...
              for (var i = 0; i < 24; i += 1) {
                ...
                var dateValue = {
                  ...
                  'display': moment.tz(hourMoment, configuration.timezone).format('LT'),
                  'active': moment.tz(hourMoment, configuration.timezone).format('YYYY-MM-DD H') === activeFormat
                };
            ...
            minute: function minute(unixDate) {
              ...
              var activeFormat = ngModelController.$modelValue ? moment.tz(ngModelController.$modelValue, configuration.timeformat, configuration.timezone).format('YYYY-MM-DD H:mm') : '';
              ...
              var result = {
                ...
                'previousViewDate': new DateObject({
                  utcDateValue: previousViewDate.valueOf(),
                  display: moment.tz(selectedDate, configuration.timezone).format('lll')
                }),
              ...
              for (var i = 0; i < limit; i += 1) {
                ...
                var dateValue = {
                  'utcDateValue': hourMoment.valueOf(),
                  'display': moment.tz(hourMoment, configuration.timezone).format('LT'),
                  'active': moment.tz(hourMoment, configuration.timezone).format('YYYY-MM-DD H:mm') === activeFormat
                };
            ...
            setTime: function setTime(unixDate) {
              ...
              var newDate = moment.tz(unixDate, configuration.timezone).format(configuration.timeformat);
          ...
          var getUTCTime = function getUTCTime(modelValue) {
            var tempDate = (modelValue ? moment.tz(modelValue, configuration.timeformat, configuration.timezone).toDate() : new Date());
